...
if __name__ == "__main__":
    ...
    iv = []
    print("16 bytes iv(separated by spaces):")
    iv = input().split()
    print(iv)
    for i in range(16):
        iv[i] = ord(iv[i])
